      ...
      >
        ...
        <div class="col-12 col-md-8 col-lg-9">
          <div class="titulo-segundo">
            <h2>
              Prueba de conocimientos sobre redes inalámbricas y equipos de
              cómputo: configuración e implementación.
            </h2>
          </div>
          <p class="mb-4">
            Validar el conocimiento adquirido sobre sobre redes inalámbricas y
            equipos de cómputo: configuración e implementación. Esto se trabaja
